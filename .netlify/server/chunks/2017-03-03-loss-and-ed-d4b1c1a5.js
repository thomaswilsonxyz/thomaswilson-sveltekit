...
__export(stdin_exports, {
  default: () => _2017_03_03_loss_and_ed,
  metadata: () => metadata
});
module.exports = __toCommonJS(stdin_exports);
var import_index_10ac95e2 = require("./index-10ac95e2.js");
const metadata = {
  "title": "Loss and my ED\u200A (\u200AED awareness week\xA02017)",
...
const _2017_03_03_loss_and_ed = (0, import_index_10ac95e2.c)(($$result, $$props, $$bindings, slots) => {
  return `<aside class="${"medium-note"}">I originally published this article in 2017 on my Medium blog. As of this update (late 2019), the reading experience on Medium has become increasingly dominated with banners, footers, and modals which ask you to sign in. I have republished it on my own site, where I will never track you, ask you to sign in, or show you adverts.
</aside>
...
<blockquote class="${"hip-hop-lyric"}">I ain&#39;t got the time to be your enemy
...
<blockquote class="${"hip-hop-lyric"}">From the view of an atom the human body&#39;s a universe
...
<cite>Tiny Glowing Screens pt. 3\u200A-\u200AWatsky</cite></blockquote>
<blockquote class="${"hip-hop-lyric"}">This is your life, you can&#39;t escape this bitch when it&#39;s hard
...
<cite>Hold Your Head Up\u200A-\u200AMacklemore</cite></blockquote>
<blockquote class="${"hip-hop-lyric"}">I feel the waves getting far too big to handle
...
<cite>Reflection\u200A-\u200AATO X EDEN</cite></blockquote>`;
});
