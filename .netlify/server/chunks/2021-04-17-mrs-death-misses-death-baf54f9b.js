...
__export(stdin_exports, {
  default: () => _2021_04_17_mrs_death_misses_death,
  metadata: () => metadata
});
...
const _2021_04_17_mrs_death_misses_death = (0, import_index_10ac95e2.c)(($$result, $$props, $$bindings, slots) => {
  return `<p>Godden has been writing and performing poetry since she decided to move to London instead of going to university. \u201CGodden is a poet\u201D headlines my review because it is so evident in every page of this book. Every transition from unknown narrator, to fourth-wall breaking direct address, to poetry, to \u201Cnormal\u201D prose. Godden barely pays attention to consistency when she writes, because she is trying to get across an idea. All books are poor transcriptions of spoken word stories that buoyed humanity through tens of thousands of years, long before we invented written word, paper, and typesetting. This book just acknowledges that more than a lot of other books I have read.</p>
<p>Mrs Death Misses Death was written almost entirely in service to an idea. Sometimes you\u2019re not sure what that idea is, and other times you\u2019re frustrated that it is <em>just</em> an idea, without resolution or arc, but most of the time you are spell-bound by how Godden writes. This is \u201Cexactly the sort of thing you expect when a poet writes a novel\u201D, to quote Sara Collins in <a href="${"https://www.theguardian.com/books/2021/feb/11/mrs-death-misses-death-by-salena-godden-review-the-poets-debut-novel"}" rel="${"nofollow"}">her review for The Guardian</a>.</p>
