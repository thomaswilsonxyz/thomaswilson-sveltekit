...
__export(stdin_exports, {
  default: () => _2020_12_20_how_are_we_going_to_write_about_this,
  metadata: () => metadata
});
...
const _2020_12_20_how_are_we_going_to_write_about_this = (0, import_index_10ac95e2.c)(($$result, $$props, $$bindings, slots) => {
  return `<p>2020 has been a terrible year in so, so many ways for so, so many people. At the very least, the Covid-19 pandemic has stolen a year from us all. I would say most of us have gone through a personal and collective trauma this year.</p>
...
<p>I am very interested in how future us will write about this once it\u2019s passed.</p>`;
});
